...
8-James_Bond gives no permissions to the owner and group ,but all permission to others over hello file.
9-John Doe sets the mode of the hello file to -rwxr-w-wx.
